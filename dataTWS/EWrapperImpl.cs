...
namespace dataTWS
{
    public class EWrapperImpl : EWrapper 
    {
        ...
        #region Methods currently used in application
        ...
        public virtual void fundamentalData(int reqId, string data)
        {
            ...
            // String callback 
            myform.AddXDocument(data);

            // string data is formatted in XML, therefore could also be loaded as Xml to be able to retrieve data;            
            //XmlDocument xDoc = new XmlDocument();
            //xDoc.LoadXml(data);
            //myform.AddListBoxItem(xDoc);
        }
        ...
        #region Methods currently not used in application
